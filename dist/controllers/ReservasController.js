...
const Reservas_1 = require("../entity/Reservas");
class ReservasController {
}
ReservasController.getReservasbyMedico = (req, res) => __awaiter(this, void 0, void 0, function* () {
    console.log(req.body, req.params);
    const id = parseInt(req.params.id);
    const reservasRepository = typeorm_1.getRepository(Reservas_1.Reservas);
    try {
        const reservas = yield reservasRepository.
            find({
            select: [
                "id",
                "inicio",
...
ReservasController.editMedico = (req, res) => __awaiter(this, void 0, void 0, function* () {
    const id = parseInt(req.params.id);
